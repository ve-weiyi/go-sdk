...
const dsn = "root:mysql7914@(127.0.0.1:3306)/INFORMATION_SCHEMA?charset=utf8mb4&parseTime=True&loc=Local"
...
func TestGenerator(t *testing.T) {
	...
	dataMap := map[string]func(detailType string) (dataType string){
		"tinyint":   func(detailType string) (dataType string) { return typeInt },
		"smallint":  func(detailType string) (dataType string) { return typeInt },
		"mediumint": func(detailType string) (dataType string) { return typeInt },
		"bigint":    func(detailType string) (dataType string) { return typeInt },
		"int":       func(detailType string) (dataType string) { return typeInt },
	}
	// 要先于`ApplyBasic`执行
	...
	autoUpdateTimeField := gen.FieldGORMTag("update_time", "column:update_time;type:datetime;autoUpdateTime")
	autoCreateTimeField := gen.FieldGORMTag("create_time", "column:create_time;type:datetime;autoCreateTime")
	...
	g.ApplyBasic(g.GenerateModel("COLUMNS", fieldOpts...))
	g.Execute()
}
