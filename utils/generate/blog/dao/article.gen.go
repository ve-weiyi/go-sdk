...
func newArticle(db *gorm.DB, opts ...gen.DOOption) article {
	...
	_article.CategoryID = field.NewInt(tableName, "category_id")
	_article.ArticleCover = field.NewString(tableName, "article_cover")
	_article.ArticleTitle = field.NewString(tableName, "article_title")
	_article.ArticleContent = field.NewString(tableName, "article_content")
	_article.Type = field.NewInt(tableName, "type")
	_article.OriginalURL = field.NewString(tableName, "original_url")
	_article.IsTop = field.NewInt(tableName, "is_top")
	_article.IsDelete = field.NewInt(tableName, "is_delete")
...
type article struct {
	...
	ID             field.Int
	UserID         field.Int    // 作者
	CategoryID     field.Int    // 文章分类
	ArticleCover   field.String // 文章缩略图
	ArticleTitle   field.String // 标题
	ArticleContent field.String // 内容
	Type           field.Int    // 文章类型 1原创 2转载 3翻译
	OriginalURL    field.String // 原文链接
	IsTop          field.Int    // 是否置顶 0否 1是
	IsDelete       field.Int    // 是否删除  0否 1是
	Status         field.Int    // 状态值 1公开 2私密 3评论可见
	CreatedAt      field.Time   // 发表时间
...
func (a *article) updateTableName(table string) *article {
	...
	a.ArticleCover = field.NewString(table, "article_cover")
	a.ArticleTitle = field.NewString(table, "article_title")
	a.ArticleContent = field.NewString(table, "article_content")
	a.Type = field.NewInt(table, "type")
	a.OriginalURL = field.NewString(table, "original_url")
	a.IsTop = field.NewInt(table, "is_top")
	a.IsDelete = field.NewInt(table, "is_delete")
...
func (a *article) fillFieldMap() {
	...
	a.fieldMap["article_cover"] = a.ArticleCover
	a.fieldMap["article_title"] = a.ArticleTitle
	a.fieldMap["article_content"] = a.ArticleContent
